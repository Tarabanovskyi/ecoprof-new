...
// =============<POP-UP>======================================================================
$('.btn-green, .documents-item__button, .callback-item__button').on('click', function (e) {
...
$(function () {
  $('.minimized').click(function (event) {
    ...
    $('body').append('<div id="overlay"><div id="close-popup"><i></i></div></div><div id="magnify"><img src="' + i_path + '"></div>');
...
$(document).ready(function () {
  $(".reviews-content__item").slice(0, 4).addClass('_active');
  $(".wrapper-button-reviews a").on("click", function (e) {

    e.preventDefault();

    $(".reviews-content__item:hidden").slice(0, 4).addClass('_active');
    if ($(".reviews-content__item:hidden").length == 0) {
      $(".wrapper-button-reviews").hide();
    }
  });
})
//=================</LOAD_MORE>=====================================================================
